class CalcController {
    ...
    calc(){        
        ...
        if(this._operation.length < 3){
            let firtsNumber = this._operation[0]
            this._operation = [firtsNumber, this._lastOperation, this._lastNumber]
        }

        if(this._operation.length > 3){
            lastValue = this._operation.pop()                   
        ...
        if(lastValue === '%'){
            ...
            this._operation = [result]
            if(lastValue) this._operation.push(lastValue)
        }        
        this.setLastNumberToDisplay()         
    }
    ...
    getLastItem(isOperator = true){
        ...
        if(!lastItem){
            lastItem = (isOperator) ? this._lastOperation : this.lastNumber
        }
